...
export const STATIC_DATA_KEYS = {
  ...
  // client opens the call in: https://<lofthost>/<roomId>. SeaMedix reads this from
  // "telemedUrl" (its value is dailystage.frontm.ai). We reuse the SAME key; if unset on
  // onship the code falls back to CALLING.LOFT_HOST. videoCall.serverUrl MUST be this bare
